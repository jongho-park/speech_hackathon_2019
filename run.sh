...
python ./main.py --log_dir log/tester --layer_size 4 --hidden_size 257 \
    --batch_size 4 --workers 2 --use_attention --max_epochs 100 --weight_decay 0.0001 --transformer_encoder --share_params
