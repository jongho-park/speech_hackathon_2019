...
import numpy as np
from . import transformer_constants as Constants
...
class Transformer(nn.Module):
    ...
    def __init__(
        ...
        assert d_model == d_word_vec, 'To facilitate the residual connections, the dimensions of \
            all module outputs shall be the same.'
        ...
        if emb_src_tgt_weight_sharing:
            ...
            assert n_src_vocab == n_tgt_vocab, "To share word embedding table, the vocabulary size \
                of src/tgt shall be the same."
